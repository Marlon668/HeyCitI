...
/**
 * Class used for configuring the testruns for visualising the diversity of the air-quality of certain
 * runs together with the average of the predictions of the this value calculated by the routingapplication
 * on every waypoint the cyclist come to
 */
public class ConfigureRun5 {
    ...
    public ConfigureRun5(SimulationRunner simulationRunner) {
        ...
        SaveButton.addActionListener(e -> {
            if (simulationRunner.getResultsBoxPlotPredicatedAirQuality() != null) {
                refresh();
                ...
                if (returnVal == JFileChooser.APPROVE_OPTION) {
                    ...
                    simulationRunner.saveResultsBoxPlotToFile2(file);
                }
            } else {
        ...
        classGenerateButton.addActionListener(e -> {
            if (simulationRunner == null) {
                ...
                if (simulationRunner.getSimulation().getInputProfile().isEmpty()) {
                    ...
                    simulationRunner.resultRunBoxPlot2(amountRuns, data);
                }
            }
        ...
        Show.addActionListener(e -> {
            if (simulationRunner.getResultsBoxPlotPredicatedAirQuality() != null) {
                ...
                Boxplot2 boxplot = new Boxplot2(simulationRunner.getResultsBoxPlotAirQuality(), simulationRunner.getResultsBoxPlotPredicatedAirQuality(), motes, 0);
        ...
        openButton.addActionListener(e -> {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    simulationRunner.readResultsBoxPlotFromFile2(fc.getSelectedFile());
